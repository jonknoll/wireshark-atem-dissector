...
atem_proto.fields = { 
  pf_packet_length, pf_flags, pf_session_id, pf_packet_id, pf_client_pkt_id,  pf_ack_pkt_id, pf_unknown1, pf_flag_ack_req, 
  pf_cmd_length, pf_cmd_name,
  pf_flag_init, pf_flag_retransmission, pf_flag_retransmit_req, pf_flag_ack,
